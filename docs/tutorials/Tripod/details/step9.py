...
from stlib.tools import BoxFilter
...
def Tripod(parent, name="Tripod", radius=55, numMotors=3, angleShift=180.0):
    ...
    #e = Effector(tripod, body.ElasticMaterialObject.dofs.getData("position").getLinkPath())
    #b.append(map(lambda x: x[0], e.roi.indices))
    ...
    #arms[0].addFrameConstraint(o.RigidParts.dofs, 0)                
    #arms[1].addFrameConstraint(o.RigidParts.dofs, 1)                
